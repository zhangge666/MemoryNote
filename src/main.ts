...
import { DatabaseManager, getInstance as getDatabaseInstance, resetInstance as resetDatabaseInstance } from './main/database/DatabaseManager';
...
async function reinitializeServices() {
  try {
    ...
    // 更新搜索服务实例
    updateSearchService(dbManager, fileSystemService);
