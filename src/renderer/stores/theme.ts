...
import { nordTheme } from '@renderer/themes/nord';
import { monokaiTheme } from '@renderer/themes/monokai';
import { forestGreenTheme } from '@renderer/themes/forest-green';
...
export const useThemeStore = defineStore('theme', () => {
  ...
  async function initialize() {
    ...
    themeService.registerTheme(nordTheme);
    themeService.registerTheme(monokaiTheme);
    themeService.registerTheme(forestGreenTheme);
   ...
   * 保存自定义主题
   */
  async function saveCustomTheme(theme: Theme) {
  ...
  function exportTheme(theme: Theme) {
    return themeService.exportTheme(theme);
  }
  ...
  function importTheme(themeJson: string) {
    return themeService.importTheme(themeJson);
  }
