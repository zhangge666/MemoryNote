<template>
  <div class="file-tree">
    ...
    <div class="tree-toolbar">
      <button class="toolbar-btn modern-btn" @click="handleNewNote" title="新建笔记">
        <svg viewBox="0 0 24 24" width="18" height="18" class="btn-icon">
          <path fill="none" stroke="currentColor" stroke-width="1.5" d="M14 2L14 8 20 8M4 4H13V9H18V20H4V4Z" stroke-linecap="round" stroke-linejoin="round"/>
          <path fill="none" stroke="currentColor" stroke-width="1.5" d="M8 12H16M8 16H16" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      </button>
      <button class="toolbar-btn modern-btn" @click="handleNewFolder" title="新建文件夹">
        <svg viewBox="0 0 24 24" width="18" height="18" class="btn-icon">
          <path fill="none" stroke="currentColor" stroke-width="1.5" d="M4 5H9L11 3H19C20.1046 3 21 3.89543 21 5V19C21 20.1046 20.1046 21 19 21H5C3.89543 21 3 20.1046 3 19V6C3 5.44772 3.44772 5 4 5Z" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      </button>
      <div class="toolbar-spacer"></div>
      <button class="toolbar-btn modern-btn" @click="handleRefresh" title="刷新">
        <svg viewBox="0 0 24 24" width="18" height="18" class="btn-icon">
          <path fill="none" stroke="currentColor" stroke-width="1.5" d="M20 12C20 16.4183 16.4183 20 12 20C7.58172 20 4 16.4183 4 12C4 7.58172 7.58172 4 12 4C14.5489 4 16.8348 5.19221 18.3694 7.08851M20 7V3M20 3H16" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      </button>
    </div>
    ...
    <div class="tree-content" v-if="!isSearching" @click="handleContentClick">
      <div v-if="treeNodes.length === 0" class="tree-empty">
        <p>暂无笔记</p>
        <button @click="handleNewNote" class="create-first-btn modern-create-btn">创建第一个笔记</button>
      </div>
...
.create-first-btn.modern-create-btn:hover::before {
  left: 100%;
}
